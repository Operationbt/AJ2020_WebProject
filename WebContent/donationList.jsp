			...
			<c:if test="${donation.getDeadline().getTime() - today >= 0}">
				...
				<c:if test="${donation.getCategory() eq cat }">
					...
					<a href="DetailViewAction.do?pid=${donation.getPid()}" class="card">
						<c:choose>
							<c:when test="${donation.getImageURL() == null || donation.getImageURL().length() == 0}">
								<img src="images/default.jpg" alt="" width="267" height="200">
							</c:when>
							<c:otherwise>
